    ...
    <div class="row">
      ...
      <main class="col-sm-8 col-lg-9 ms-sm-auto px-md-4">
          ...
          <div class="d-flex align-items-center flex-shrink-0 p-3 link-dark text-decoration-none border-bottom justify-content-between">
            <h2>
              <span class="fs-5 fw-semibold">Taak toevoegen</span>
            </h2>
          </div>
        <div>

        <form class="needs-validation pt-3" method="post" action="create-task-verwerk.php">
          <div class="row g-3">
            <div class="col-sm-12">
            ...
            <div class="col-12">
              <label for="lijst" class="form-label">Toevoegen aan lijst</label>

              <!-- Maak deze lijst dynamisch waarbij de waarden uitgelezen worden uit de database  -->
              <select class="form-select" name="listid" id="lijst" required="">
                
                  <option value="1">Lijst 1</option>
                  <option value="2">Lijst 2</option>
                  <option value="3">Lijst 3</option>
